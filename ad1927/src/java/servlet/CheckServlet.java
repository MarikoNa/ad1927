...
public class CheckServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Account account = (Account) dao.findByLogin(login);
        
        int morning = account.getMorning();
        int noon = account.getNoon();
        int night = account.getNight();
     
        request.setAttribute("morning", morning);
        request.setAttribute("noon", noon);
        request.setAttribute("night", night);
        request.setAttribute("sum", morning+noon+night);
